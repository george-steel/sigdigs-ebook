...
\newfontfamily\titlefont{Kelmscott}
...
\newcommand\qsource[1]{\sourceatright{— \upshape #1\quad}}
...
\nouppercaseheads
\makeevenhead{headings}{\makebox[0pt][r]{\thepage\enspace}\adfleafright}{}{{\footnotesize\titlefont Significant Digits}}
\makeoddhead{headings}{}{}{{\footnotesize\titlefont\leftmark}\quad\adfleafleft\makebox[0pt][l]{\enspace\thepage}}
...
%\renewcommand\afterchapternum{\par\bigskip\includegraphics[height=1.5in]{images/chapternums/big-\thechapter.pdf}\par\bigskip}
...
\def\mybreak{\bigskip\fancybreak{\leavevmode\large\kern28pt\cleaders\hbox{\kding m}\hfill{\!\kding r\!}\cleaders\hbox{\rkding m}\hfill\kern28pt}\bigskip}
